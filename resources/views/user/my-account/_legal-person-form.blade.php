...
<div class="row my-4">
	<div class="col">
		<div class="form-group">
			...
			<input disabled class="form-control" type="text" value="{{ $user->company_name }}" required>
		</div>
	</div>
...
<div class="row my-4">
	<div class="col">
		...
		<input name="birth_date" class="form-control birth-date" type="text" value="{{ $user->birth_date }}">
	</div>
