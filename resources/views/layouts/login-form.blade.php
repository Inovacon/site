<form action="{{ route('login') }}" method="POST">
  ...
  <div class="form-group">
    <label for="login-email" class="font-weight-600 small"><i class="fas fa-envelope fa-md"></i>&nbsp;&nbsp;E-MAIL</label>
    <input type="email" class="form-control" id="login-email" name="email" placeholder="email@exemplo.com" value="{{ old('email') }}" required>
  </div>
  <div class="form-group">
    <label for="login-password" class="font-weight-600 small"><i class="fas fa-lock fa-md">&nbsp;&nbsp;</i>SENHA</label>
